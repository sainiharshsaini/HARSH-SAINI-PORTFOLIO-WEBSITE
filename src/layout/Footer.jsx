...
const Footer = () => {
  return (
    <footer className='border-t border-slate-300 dark:border-slate-800 p-8 lg:pt-12 text-lightTextPrimary dark:text-darkTextPrimary'>
          ...
          <div className='flex flex-col justify-between items-center lg:items-start p-5 lg:py-0'>
            <div>
              ...
              <ul className='flex justify-start items-center py-4 gap-6 md:gap-8 text-3xl'>
                <li>
                  <Link to="https://www.linkedin.com/in/harsh-saini-158709238" target='_blank'><i className="fa-brands fa-linkedin-in hover:text-blue-500"></i></Link>
                </li>
                <li>
                  <Link to="https://x.com/harshsaini_18?t=_zx6F5EH11KJBifgNn7TxA&s=09" target='_blank'><i className="fa-brands fa-twitter hover:text-blue-700"></i></Link>
                </li>
                <li>
                  <Link to="https://github.com/sainiharshsaini" target='_blank'><i className="fa-brands fa-github hover:text-gray-600"></i></Link>
                </li>
                <li>
                  <Link to="https://wa.me/qr/4AD67ER2Z2ZRD1" target='_blank'><i className="fa-brands fa-whatsapp hover:text-green-500"></i></Link>
                </li>
              </ul>
            </div>
          </div>

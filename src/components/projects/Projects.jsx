                ...
                <div className='flex items-center gap-3'>
                  {
                    techUsed.map(({ id, icon }) => (
                      <img className='w-7' src={icon} key={id} />
                    ))
                  }
                </div>
                <div className='flex justify-between items-center gap-4'>
                  <Link className='py-1 px-4 w-2/4 text-sm text-center bg-gradient-to-b from-blue-400 to-blue-700 hover:from-slate-400 hover:to-slate-700 rounded-sm text-white font-medium' to={githubLink} target='_blank'><i className="fa-brands fa-github"></i> SOURCE CODE</Link>
                  <Link className='py-1 px-4 w-2/4 text-sm text-center bg-gradient-to-b from-blue-400 to-blue-700 hover:from-slate-400 hover:to-slate-700 rounded-sm text-white font-medium' to={deployLink} target='_blank'><i className="fa-solid fa-eye"></i> VIEW PROJECT</Link>
                </div>
              </div>
            </div>
          </div>
